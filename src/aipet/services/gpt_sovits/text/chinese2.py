...
if is_g2pw:
    ...
    parent_directory = os.path.dirname(current_file_path)  # gpt_sovits
    ...
    g2pw_model_source = os.environ.get(
        "bert_path", 
        os.path.join(base_model_dir, "chinese-roberta-wwm-ext-large")
    )
    
    g2pw = G2PWPinyin(
        model_dir=g2pw_model_dir,
        model_source=g2pw_model_source,
        v_to_u=False,
